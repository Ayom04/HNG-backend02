...
describe("POST /auth/register", () => {
  ...
  it("should fail if required fields are missing", async () => {
    ...
    expect(res.body.errors[0]).to.have.property("message", "First name is required");
    expect(res.body.errors[1]).to.have.property("field", "lastName");
    expect(res.body.errors[1]).to.have.property("message", "Last name is required");
    ...
    expect(res.body.errors[3]).to.have.property("message", "Password is required");
